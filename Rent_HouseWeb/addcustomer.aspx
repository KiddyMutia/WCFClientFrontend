<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addcustomer.aspx.cs" Inherits="Rent_HouseWeb.addcustomer" %>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung
    <a href="addcustomer.aspx">addcustomer.aspx</a>, LG, SonyEricsson, Motorola web design" />
					...
					<div class="grid-form1">
                        ...
                        <form class="form-horizontal" runat="server">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <asp:DropDownList type="text" CssClass="form-control" ID="cb_type" placeholder="Name of Customer" runat="server">
                                <asp:ListItem Value="KTP" Text="KTP"></asp:ListItem>
                                <asp:ListItem Value="KTM" Text="KTM"></asp:ListItem>
                              </asp:DropDownList>
                            </div>
                          </div>
                          <div class="form-group">
                        ...
                        <hr />
                          <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                              <asp:Button CssClass="btn btn-default" Text="Save" OnClick="btn_saveClick" runat="server" />
                            </div>
                          </div>
                        </form>
                     </div>
