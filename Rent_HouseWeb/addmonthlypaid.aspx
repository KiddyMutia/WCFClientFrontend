<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addmonthlypaid.aspx.cs" Inherits="Rent_HouseWeb.addmonthlypaid" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head>
<title>Rent House Admin Panel | Add Monthly Paid</title>
       ...
       <div class="content-main">
  		...
  		<!--banner-->	
		    <div class="banner">
				...
				<h2>
				<a href="#">Monthly Paid Transaction</a>
				<i class="fa fa-angle-right"></i>
				<span>Add Monthly Paid</span>
				</h2>
		    </div>
		<!--//banner-->
		<!--content-->
