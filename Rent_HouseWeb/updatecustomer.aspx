<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updatecustomer.aspx.cs" Inherits="Rent_HouseWeb.updatecustomer" %>
			...
			<div class="col-md-12 ">
					...
					<div class="grid-form1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <asp:TextBox disabled type="text" CssClass="form-control" ID="tb_id" placeholder="Name of Customer" runat="server" required=""></asp:TextBox>
                            </div>
                          </div>
                          <div class="form-group">
