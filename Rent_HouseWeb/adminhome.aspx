<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminhome.aspx.cs" Inherits="Rent_HouseWeb.adminhome" %>
			...
			<div class="col-md-12 ">
				<div class="content-top-1">
					...
					<div class="table-responsive">
                        <form runat="server">
                            <p>Hello, <asp:Label ID="lbl_name2" runat="server"></asp:Label> Welcome Back ! If you want to logout, click button below</p>
                            <br />
                            <asp:Button CssClass="btn btn-sm btn-danger" Text="Logout" OnClick="btn_logoutClick" runat="server" />
                        </form>
                    </div>
