<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="monthlytransaction.aspx.cs" Inherits="Rent_HouseWeb.monthlytransaction" %>
					...
					<div class="grid-form1">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <asp:TextBox type="text" CssClass="form-control" ID="tb_idtrans" placeholder="Transaction ID" runat="server"></asp:TextBox>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Room</label>
                            <div class="col-sm-10">
                              <asp:TextBox ID="tb_room" runat="server"></asp:TextBox>
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <asp:TextBox ID="tb_customerid" runat="server"></asp:TextBox>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Total Price</label>
                            <div class="col-sm-10">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:TextBox ID="tb_info" TextMode="MultiLine" runat="server"></asp:TextBox>
                            </div>
                          </div>
                        <hr />
                          <div class="form-group">
