<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_edit_news.aspx.cs" Inherits="Rent_HouseWeb.admin_edit_news" %>
		...
		<div class="content-top">
			...
			<div class="col-md-12 ">
					...
					<div class="grid-form1">
                        <h3 id="forms-horizontal">Add News</h3>
                        <form id="Form1" class="form-horizontal" runat="server">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Title</label>
                            <div class="col-sm-10">
                              <asp:TextBox type="text" CssClass="form-control" ID="tb_title" placeholder="Title of News" runat="server" required=""></asp:TextBox>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label hor-form">Contains</label>
                            <div class="col-sm-10">
                              <asp:TextBox type="text" CssClass="form-control" ID="tb_contains" placeholder="Name of User" runat="server" TextMode="MultiLine" required=""></asp:TextBox>
                            </div>
                          </div>
                        <hr />
                          <div class="form-group">
