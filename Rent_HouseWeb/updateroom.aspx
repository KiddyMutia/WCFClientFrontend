<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateroom.aspx.cs" Inherits="Rent_HouseWeb.updateroom" %>
                        ...
                        <form id="Form1" class="form-horizontal" runat="server">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <asp:DropDownList ID="cb_roomtype" runat="server" >
                              </asp:DropDownList>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <asp:DropDownList ID="cb_status" runat="server" >
